...
REGISTRY: dict[str, MCPIntegration] = {
    ...
    "billing_datadog": MCPIntegration(
        name="billing_datadog",
        display_name="Datadog Billing (usage/cost)",
        config_type=MCP_CONFIG_TYPES["billing_datadog"],
        category="Billing",
        required_env=("DD_API_KEY", "DD_APP_KEY"),  # APP key needs usage_read+billing_read
        tool_names=(
        ...
        factory=_lazy("opsrag.mcp.billing_datadog", "build"),
        fake_factory=_lazy("opsrag.mcp.billing_datadog", "build_fake"),
    ),
    "billing_gcp": MCPIntegration(
        name="billing_gcp",
        display_name="GCP Billing (cost/spend)",
        config_type=MCP_CONFIG_TYPES["billing_gcp"],
        category="Billing",
        required_env=("OPSRAG_GCP_BILLING_TABLE",),  # ADC for auth; table locates the export
        tool_names=(
        ...
        factory=_lazy("opsrag.mcp.billing_gcp", "build"),
        fake_factory=_lazy("opsrag.mcp.billing_gcp", "build_fake"),
    ),
    "billing_kubecost": MCPIntegration(
        name="billing_kubecost",
        display_name="Kubecost (K8s cost allocation)",
        config_type=MCP_CONFIG_TYPES["billing_kubecost"],
        category="Billing",
        required_env=("OPSRAG_KUBECOST_URL",),
        tool_names=(
        ...
        factory=_lazy("opsrag.mcp.billing_kubecost", "build"),
        fake_factory=_lazy("opsrag.mcp.billing_kubecost", "build_fake"),
    ),
    "billing_mongodb_atlas": MCPIntegration(
        name="billing_mongodb_atlas",
        display_name="MongoDB Atlas Billing (invoices)",
        config_type=MCP_CONFIG_TYPES["billing_mongodb_atlas"],
        category="Billing",
        required_env=("OPSRAG_ATLAS_ORG_ID",),  # + OAuth2 SA or API keys (checked at call time)
        tool_names=(
        ...
        factory=_lazy("opsrag.mcp.billing_mongodb_atlas", "build"),
        fake_factory=_lazy("opsrag.mcp.billing_mongodb_atlas", "build_fake"),
    ),
